...
#             self.library.manage_reservation(self, book)
#             self.books_borrowed.append(book)
#         else:
#             print(f"Sorry, '{book.title}' is not available for borrowing.")
#
#     def return_book(self, book):
#         if book in self.books_borrowed:
#             self.library.cancel_book_reservation(self, book)
#             self.books_borrowed.remove(book)
#             print(f"{self.name} has returned '{book.title}'.")
#         else:
#             print(f"{self.name} did not borrow '{book.title}' from the library.")
...
#
#     def register_member(self, name, age):
#         new_member = Member(name, age, self)
#         self.members.append(new_member)
#         print(f"Member {name} registered with ID {new_member.member_id}.")
#
#     def hire_librarian(self, name, age):
...
#             print(f"Sorry, '{book.title}' is not available for borrowing.")
#
#     def cancel_book_reservation(self, member, book):
#         reservation = next(
#             (r for r in self.reservations if r.member == member and r.book == book and r.status == "Active"), None)
#         if reservation:
#             reservation.cancel_reservation()
#         else:
#             print("No active reservation found for this book and member.")
#
#
# class Reservation:
#     reservation_counter = 1
#
#     def __init__(self, reservation_id, member, book, reservation_date):
#         self.reservation_id = Reservation.generate_unique_id()
#         self.member = member
#         self.book = book
#         self.reservation_date = reservation_date
...
#     @classmethod
#     def generate_unique_id(cls):
#         id_ = 'M' + str(cls.reservation_counter)
#         cls.reservation_counter += 1
#         return id_
#
#     def cancel_reservation(self):
...
#             print(f"Reservation {self.reservation_id} for {self.member.name} and '{self.book.title}' cancelled.")
#         else:
#             print("Reservation is already cancelled or completed.")
#
#
# if __name__ == "__main__":
#     my_library = Library("My Awesome Library")
